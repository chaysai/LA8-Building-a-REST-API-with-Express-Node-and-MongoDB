...
mongoose.connect('mongodb://localhost:27017/student', { useNewUrlParser: true }) const db = mongoose.connection
...
app.post('/students', async (req, res) => { const { name, age, grade } = req.body;
...
app.put('/students/:id', async (req, res) => { const { id } = req.params; const { name, age, grade } = req.body;
